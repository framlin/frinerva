...
export class CreateAccountController extends UseCaseController {
    ...
    register_request_channel_receiver() {
        ...
        this._request_channel.register_receiver('create_account:period_cost_center-selected', (e, period_cost_center) => {
            this.on_period_cost_center_selection(period_cost_center);
        });
        this._request_channel.register_receiver('create_account:create', (e, new_accounts_list) => {
